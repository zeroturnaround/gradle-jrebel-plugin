...
Refer to [application configuration using rebel.xml](http://manuals.zeroturnaround.com/jrebel/standalone/config.html) for file format details.
...
When your project uses the Gradle War plugin:
...
In some cases, the out-of-box configuration will be insufficient and you need to set some configuration explicitly. To get an idea about this, start off by having a look at the *rebel.xml* that was generated based on the defaults, and figure out where is it going wrong.  
